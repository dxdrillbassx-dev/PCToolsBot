...
*Телеграм канал разработчика:* [@dxdrillbassx-dev](https://t.me/dxdrillbassx_dev)
*Репозиторий GitHub:* [КЛИК](https://github.com/dxdrillbassx-dev/PCToolsBot)
'''
