...
## Как закинуть файл в автозагрузку
*1)* Сохраняем файл и переходим в консоль<br/>
*2)* пишем cd путь директории где лежит файл PCToolsBot.py (cd C:\download)<br/>
*3)* Пишем в консоли pyinstaller -w -F PCToolsBot.py<br/>
*4)* Перемещаем из папки dist exe-шник в удобну нам папку, создаем ярлык exe-шника<br/>
*5)* Кидаем ярлык в папку автозагрузки C:\Users\Имя_Пользователя\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup<br/>

## Разработчик
- Телеграм канал: [@dxdrillbassx-dev](https://t.me/dxdrillbassx_dev)
